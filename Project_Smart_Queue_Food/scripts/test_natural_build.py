...
def build_doc(toc_pages=None):
    ...
    add_toc_line(doc, "6.0  แผนภาพสรุป Business Model Canvas 9 ช่อง", toc_pages['ch6'], indent=0.25)
    add_toc_line(doc, "6.1  พันธมิตรหลัก (Key Partners)", toc_pages['ch6'], indent=0.25)
    add_toc_line(doc, "6.2  กิจกรรมหลัก (Key Activities)", toc_pages['ch6_2'], indent=0.25)
    add_toc_line(doc, "6.3  ทรัพยากรหลัก (Key Resources)", toc_pages['ch6_2'], indent=0.25)
    add_toc_line(doc, "6.4  คุณค่าที่ส่งมอบ (Value Propositions)", toc_pages['ch6_2'], indent=0.25)
    add_toc_line(doc, "6.5  ความสัมพันธ์กับลูกค้า (Customer Relationships)", toc_pages['ch6_2'], indent=0.25)
    add_toc_line(doc, "6.6  ช่องทางการเข้าถึง (Channels)", toc_pages['ch6_6'], indent=0.25)
    add_toc_line(doc, "6.7  กลุ่มลูกค้าเป้าหมาย (Customer Segments)", toc_pages['ch6_6'], indent=0.25)
    add_toc_line(doc, "6.8  โครงสร้างต้นทุน (Cost Structure)", toc_pages['ch6_6'], indent=0.25)
    add_toc_line(doc, "6.9  แหล่งที่มารายได้ (Revenue Streams)", toc_pages['ch6_6'], indent=0.25)
    ...
    add_toc_line(doc, "10.4  ปัจจัยแห่งความสำเร็จ (Critical Success Factors)", toc_pages['ch10_3'], indent=0.25)
    add_toc_line(doc, "10.5  ข้อเสนอแนะและทิศทางการพัฒนาในอนาคต", toc_pages['ch10_3'], indent=0.25)
    ...
    # =========================================================================
    # CHAPTER 1: BUSINESS IDEA & PROBLEM STATEMENT (เป๊ะ 3 หน้าเต็ม พอดีเป๊ะ)
    # =========================================================================
    ...
    add_body_p(doc, "ในสถาบันอุดมศึกษาขนาดใหญ่ เช่น มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ (มจพ.) ซึ่งมีจำนวนนักศึกษาและบุคลากรรวมกันมากกว่า 25,000 คน กิจกรรมการรับประทานอาหารกลางวันเป็นกิจวัตรที่มีความหนาแน่นสูงสุดในรอบวัน โดยเฉพาะในช่วงเวลาเร่งด่วนระหว่าง 11:30 น. ถึง 13:00 น. ซึ่งเป็นช่วงเวลาพักการเรียนการสอนของคณะส่วนใหญ่ ส่งผลให้เกิดปัญหาความแออัดและการรอคอยคิวที่ยาวนานในโรงอาหารของมหาวิทยาลัยอย่างหลีกเลี่ยงไม่ได้")
    add_body_p(doc, "จากการศึกษาและสำรวจข้อมูลเชิงประจักษ์ในโรงอาหารกลาง มจพ. พบว่าประชาคมชาวมหาวิทยาลัยต้องเผชิญกับปัญหาสำคัญ 4 ประการ ดังนี้:")
    add_numbered_item(doc, "1)", "ระยะเวลาการรอคอยอาหารเฉลี่ย 20 ถึง 30 นาทีต่อมื้อ คิดเป็นเกือบครึ่งหนึ่งของเวลาพักกลางวัน ทำให้นักศึกษาต้องรีบรับประทานอาหาร เกิดภาวะตึงเครียด และนำไปสู่การเข้าเรียนภาคบ่ายล่าช้า", space_after=1)
    add_numbered_item(doc, "2)", "ความแออัดในพื้นที่ทางกายภาพของโรงอาหาร แถวคิวยาวกีดขวางทางเดิน โต๊ะที่นั่งรับประทานอาหารไม่เพียงพอ ส่งผลกระทบต่อสุขอนามัยและบรรยากาศการใช้ชีวิตในมหาวิทยาลัย", space_after=1)
    add_numbered_item(doc, "3)", "ความผิดพลาดในการจัดการคำสั่งซื้อของร้านค้า ในชั่วโมงเร่งด่วนที่คำสั่งซื้อเข้ามาพร้อมกัน การจดด้วยกระดาษทำให้เกิดความผิดพลาด ลำดับคิวสับสน อาหารตกหล่น และสร้างความไม่พึงพอใจ", space_after=1)
    add_numbered_item(doc, "4)", "คอขวดในขั้นตอนการชำระเงิน แม้ปัจจุบันจะมีการใช้ PromptPay แต่การสแกนจ่ายเงินหน้าร้านค้าขณะที่แม่ค้ากำลังปรุงอาหารทำให้คิวหยุดชะงัก เนื่องจากต้องรอเปิดหน้าจอและตรวจสอบยอดเงินทีละรายการ", space_after=1)

    # --- Page 2 (22 lines) ---
    add_heading_1(doc, "1.2  โอกาสทางการตลาดและพฤติกรรมผู้บริโภค (Market Opportunity)", page_break_before=False)
    add_body_p(doc, "จากการวิเคราะห์สภาพแวดล้อมทางเทคโนโลยีและพฤติกรรมของกลุ่มเป้าหมาย พบโอกาสทางธุรกิจ 3 ประการ:")
    add_numbered_item(doc, "1)", "ความคุ้นเคยกับสมาร์ตโฟน: นักศึกษาและบุคลากรทุกคนใช้งาน LINE เป็นประจำ การสั่งอาหารผ่าน LINE LIFF จึงเปิดใช้งานได้ทันทีโดยไม่ต้องเรียนรู้ใหม่และไม่ต้องติดตั้งแอปเพิ่มเติม", space_after=1)
    add_numbered_item(doc, "2)", "ช่องว่างของแอปพลิเคชันเดลิเวอรี่: แพลตฟอร์มทั่วไปคิดค่า GP สูงถึง 30-35% และมีค่าส่ง ซึ่งไม่เหมาะกับโรงอาหาร Smart Queue Food จึงตอบโจทย์ด้วยค่าธรรมเนียมต่ำมากและเน้นการรับอาหารด้วยตนเอง", space_after=1)
    add_numbered_item(doc, "3)", "นโยบายสนับสนุนของสถาบัน: สอดรับกับยุทธศาสตร์ Smart Campus และนโยบายสังคมไร้เงินสด (Cashless Society) ของมหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนืออย่างแท้จริง", space_after=1)

    add_heading_1(doc, "1.3  แนวคิดและคำตอบของนวัตกรรม (Solution Concept)")
    add_body_p(doc, "ระบบ 'Smart Queue Food' ถูกออกแบบเป็นนวัตกรรมบริการดิจิทัลบน LINE Official Account เชื่อมโยงผู้บริโภคเข้ากับหน้าจอจัดการครัว (KDS) และระบบชำระเงิน PromptPay ผู้ใช้สามารถเลือกดูเมนู สั่งอาหารล่วงหน้าก่อนเวลาพัก เลือกรอบเวลารับอาหาร และชำระเงินดิจิทัลทันที เมื่อร้านค้าปรุงอาหารใกล้เสร็จ ระบบจะส่งข้อความแจ้งเตือนผ่าน LINE ให้นักศึกษาเดินมารับอาหารได้พอดีเวลาโดยไม่ต้องยืนรอคิวหน้าร้าน")
    ...
    # --- Page 3 (22 lines) ---
    add_heading_1(doc, "1.5  ขอบเขตของโครงงาน (Project Scope)", page_break_before=False)
    add_numbered_item(doc, "1)", "ดำเนินการศึกษาและพัฒนาระบบนำร่อง ณ โรงอาหารกลาง มจพ. (กรุงเทพฯ) โดยเชื่อมต่อร้านอาหารนำร่องจำนวน 15 ร้านค้า ครอบคลุมกลุ่มเป้าหมายนักศึกษา อาจารย์ และบุคลากรภายในมหาวิทยาลัย", bold_prefix="ขอบเขตด้านพื้นที่และกลุ่มเป้าหมาย: ", space_after=2)
    add_numbered_item(doc, "2)", "ครอบคลุมระบบสั่งอาหาร LINE Front-end Framework (LIFF), ระบบจัดสรรคิวไดนามิก, ระบบชำระเงิน Dynamic PromptPay, ระบบแจ้งเตือนอัตโนมัติ และระบบหน้าจอร้านค้า (Kitchen Display System: KDS)", bold_prefix="ขอบเขตด้านระบบซอฟต์แวร์: ", space_after=2)
    add_numbered_item(doc, "3)", "ดำเนินงานตลอดภาคเรียนที่ 1 ปีการศึกษา 2569 ตั้งแต่ขั้นตอนการสำรวจปัญหา ออกแบบสถาปัตยกรรม พัฒนาและทดสอบต้นแบบ จนถึงการประเมินผลลัพธ์เชิงธุรกิจและความเป็นไปได้ทางการเงิน", bold_prefix="ขอบเขตด้านระยะเวลา: ", space_after=2)

    add_heading_1(doc, "1.6  ประโยชน์ที่คาดว่าจะได้รับ (Expected Benefits)")
    add_numbered_item(doc, "1)", "ประหยัดเวลาการรอคอยอาหาร มีเวลาพักผ่อนและรับประทานอาหารเพิ่มขึ้น ส่งเสริมสุขอนามัยและประสิทธิภาพการเรียนรู้", bold_prefix="ด้านนักศึกษาและบุคลากร: ", space_after=2)
    add_numbered_item(doc, "2)", "บริหารจัดการคิวในครัวได้อย่างมีแบบแผน ลดข้อผิดพลาดของรายการอาหาร และเพิ่มยอดขายรวมในชั่วโมงเร่งด่วน", bold_prefix="ด้านผู้ประกอบการร้านอาหาร: ", space_after=2)
    add_numbered_item(doc, "3)", "ลดความแออัดในพื้นที่ส่วนรวม ยกระดับความปลอดภัยทางสุขอนามัย และขับเคลื่อนมหาวิทยาลัยสู่การเป็น Smart Campus", bold_prefix="ด้านมหาวิทยาลัย: ", space_after=2)
    ...
    # --- Page 2 (Table 2.1 unbroken) ---
    add_heading_1(doc, "2.4  เป้าหมายเชิงกลยุทธ์ (Strategic Goals)", page_break_before=False)
    ...
    add_numbered_item(doc, "1)", "ประหยัดเวลาการรอคอยอาหารเฉลี่ย 15-20 นาทีต่อมื้อ สามารถสั่งอาหารล่วงหน้าระหว่างเดินเปลี่ยนคาบ ทราบเวลาเสร็จแน่นอน ไม่ต้องยืนรอท่ามกลางความร้อน และจ่ายค่าอาหารตามราคาปกติหน้าร้านโดยไม่มีค่าส่ง", bold_prefix="คุณค่าสำหรับนักศึกษาและบุคลากร: ", space_after=2)
    add_numbered_item(doc, "2)", "สามารถวางแผนการปรุงอาหารล่วงหน้าได้อย่างราบรื่น ลดปัญหาออเดอร์ตกหล่น ลดความแออัดหน้าร้าน เพิ่มขีดความสามารถรับออเดอร์ช่วงเร่งด่วนได้มากขึ้น 20-30% และรับเงินถูกต้องผ่าน PromptPay ไร้ปัญหาเงินทอน", bold_prefix="คุณค่าสำหรับผู้ประกอบการร้านอาหาร: ", space_after=2)
    add_numbered_item(doc, "3)", "ช่วยระบายความแออัดในโรงอาหาร ส่งเสริมสุขอนามัยที่ดี ลดปัญหาการแย่งโต๊ะที่นั่ง และส่งเสริมนโยบาย Smart Campus และสังคมไร้เงินสดอย่างเป็นรูปธรรม", bold_prefix="คุณค่าสำหรับมหาวิทยาลัย: ", space_after=2)
    ...
    # --- Page 2 (Table 3.1 unbroken) ---
    add_heading_1(doc, "3.3  การเปรียบเทียบคุณค่าเชิงลึกกับทางเลือกอื่นในตลาด", page_break_before=False)
    ...
    # =========================================================================
    # CHAPTER 4: PRODUCT CHARACTERISTICS & ARCHITECTURE (เป๊ะ 3 หน้าเต็ม พอดีเป๊ะ)
    # =========================================================================
    start_chapter_section(doc)
    ...
    add_numbered_item(doc, "1)", "แสดงรายการร้านค้า เมนูอาหาร ภาพประกอบ ราคา และตัวเลือกปรับแต่งอย่างละเอียด เช่น ระดับความเผ็ด การเพิ่มไข่ดาว และหมายเหตุพิเศษ ช่วยให้ผู้ใช้เลือกอาหารและสั่งล่วงหน้าได้อย่างสะดวก", bold_prefix="ระบบแสดงเมนูและสั่งอาหารล่วงหน้า (Pre-ordering & Catalog): ", space_after=2)
    add_numbered_item(doc, "2)", "อัลกอริทึมคำนวณเวลาการรอคอยโดยประมาณ (EWT) โดยนำเวลาปรุงเฉลี่ยของแต่ละเมนูคูณด้วยจำนวนคิวสะสมแบบเรียลไทม์ พร้อมเปิดให้ผู้ใช้เลือกรอบเวลารับอาหารล่วงหน้าได้อย่างแม่นยำ", bold_prefix="ระบบจัดสรรคิวและประเมินเวลารอคอย (Predictive Queue): ", space_after=2)
    add_numbered_item(doc, "3)", "สร้าง Dynamic PromptPay QR Code ที่ฝังยอดเงินตรงตามบิลคำสั่งซื้อโดยอัตโนมัติ พร้อมระบบ Slip Verification API ตรวจสอบสลิปกับธนาคารภายใน 3 วินาที ลดเวลาชำระเงินหน้าร้านให้เป็นศูนย์", bold_prefix="ระบบชำระเงินดิจิทัลไร้เงินสด (PromptPay Payment Gateway): ", space_after=2)
    add_numbered_item(doc, "4)", "ส่งข้อความแจ้งเตือนอัตโนมัติผ่าน LINE Messaging API เข้าสู่แชทของผู้ใช้ 3 ขั้นตอน ได้แก่ ร้านค้ารับออเดอร์, กำลังเริ่มปรุงอาหาร, และอาหารปรุงเสร็จพร้อมรับ เพื่อให้เดินมารับอาหารได้พอดีเวลา", bold_prefix="ระบบแจ้งเตือนสถานะคำสั่งซื้อเรียลไทม์ (Push Notification): ", space_after=2)
    add_numbered_item(doc, "5)", "เว็บแอปพลิเคชันบนแท็บเล็ตประจำร้านค้า แสดงการ์ดออเดอร์เรียงตามลำดับคิวและเวลา พร้อมตัวอักษรขนาดใหญ่และปุ่มกดเปลี่ยนสถานะที่ใช้งานง่าย แม้ในช่วงเวลาเร่งด่วนที่แม่ค้ากำลังปรุงอาหาร", bold_prefix="ระบบหน้าจอจัดการครัวสำหรับร้านค้า (Kitchen Display System: KDS): ", space_after=2)

    # --- Page 2 (Architecture Image & Layers) ---
    add_heading_1(doc, "4.2  สถาปัตยกรรมระบบและโครงสร้างเทคโนโลยี (System Architecture)", page_break_before=False)
    ...
    add_figure(doc, arch_img, "4.1", "แผนภาพสถาปัตยกรรมระบบ Smart Queue Food (System Architecture)", width_inches=3.8)
    ...
    # --- Page 3 (UI Mockup & Screens) ---
    add_heading_1(doc, "4.3  ภาพจำลองส่วนต่อประสานผู้ใช้งานจริง (UI Prototype & User Experience)", page_break_before=False)
    ...
    add_figure(doc, ui_img, "4.2", "ภาพจำลองส่วนต่อประสานผู้ใช้งานจริง (UI Prototype)", width_inches=3.8)
    ...
    # --- Page 2 (18 lines) ---
    add_heading_1(doc, "5.3  การประมาณการขนาดตลาด (TAM, SAM, SOM)", page_break_before=False)
    add_body_p(doc, "การประเมินขนาดตลาดตามระเบียบวิธีวิเคราะห์ธุรกิจเทคโนโลยี:")
    add_numbered_item(doc, "1)", "โรงอาหารในสถาบันอุดมศึกษาทั่วประเทศประมาณ 150 แห่ง นักศึกษาและบุคลากรกว่า 1.5 ล้านคน มูลค่าการใช้จ่ายอาหารกลางวันเฉลี่ย 4,500 ล้านบาทต่อปี (คำนวณจากค่าอาหารเฉลี่ย 50 บาท/มื้อ x 200 วันทำการ)", bold_prefix="Total Addressable Market (TAM): ", space_after=2)
    add_numbered_item(doc, "2)", "โรงอาหารในสถาบันอุดมศึกษาเขตกรุงเทพฯ และปริมณฑล 30 แห่ง นักศึกษาและบุคลากรรวมประมาณ 300,000 คน มูลค่าตลาดอาหารกลางวันประมาณ 900 ล้านบาทต่อปี", bold_prefix="Serviceable Available Market (SAM): ", space_after=2)
    add_numbered_item(doc, "3)", "โรงอาหารกลาง มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ (กรุงเทพฯ) นักศึกษาและบุคลากรเป้าหมาย 12,000 คน มูลค่าตลาดอาหารกลางวันประมาณ 36 ล้านบาทต่อปี โดยโครงการตั้งเป้าหมายเจาะตลาดนำร่องร้อยละ 25 ในปีแรก (มูลค่าธุรกรรมผ่านระบบประมาณ 9 ล้านบาทต่อปี)", bold_prefix="Serviceable Obtainable Market (SOM): ", space_after=2)
    ...
    # =========================================================================
    # CHAPTER 6: BUSINESS MODEL CANVAS (เป๊ะ 3 หน้าเต็ม พอดีเป๊ะ)
    # =========================================================================
    start_chapter_section(doc)
    add_chapter_title(doc, "6", "แบบจำลองผืนผ้าใบธุรกิจ (Business Model Canvas - BMC)\n(Business Model Canvas)")

    # --- Page 1 ---
    add_heading_1(doc, "6.0  แผนภาพสรุป Business Model Canvas 9 ช่อง")
    add_body_p(doc, "รูปที่ 6.1 แสดงแผนภาพสรุป Business Model Canvas 9 องค์ประกอบของโครงการ Smart Queue Food:", space_after=1)

    bmc_img = os.path.join(ASSETS_DIR, 'bmc_graphic.png')
    add_figure(doc, bmc_img, "6.1", "แบบจำลองผืนผ้าใบธุรกิจ 9 ช่อง (Business Model Canvas)", width_inches=3.8)

    add_body_p(doc, "แบบจำลองผืนผ้าใบธุรกิจฉบับนี้ถูกพัฒนาขึ้นจากการวิเคราะห์ความต้องการที่แท้จริงของผู้มีส่วนได้ส่วนเสียใน มจพ. โดยเชื่อมโยง 9 องค์ประกอบเข้าด้วยกันอย่างสอดประสาน เพื่อสร้างโมเดลธุรกิจที่มีความยั่งยืนและขยายผลได้จริง", space_after=1)

    add_heading_1(doc, "6.1  พันธมิตรหลัก (Key Partners)")
    add_numbered_item(doc, "1)", "ฝ่ายบริหารอาคารสถานที่และศูนย์อาหาร มจพ., สโมสรนักศึกษา และคณะต่างๆ", bold_prefix="มหาวิทยาลัย: ", space_after=1)
    add_numbered_item(doc, "2)", "ผู้ประกอบการร้านอาหารปรุงสดในโรงอาหารกลางและอาคาร 40 ปี", bold_prefix="ร้านค้า: ", space_after=1)
    add_numbered_item(doc, "3)", "LINE Thailand สำหรับ LINE Developers API และธนาคารพาณิชย์สำหรับระบบ PromptPay", bold_prefix="พันธมิตรเทคโนโลยี: ", space_after=1)

    # --- Page 2 ---
    add_heading_1(doc, "6.2  กิจกรรมหลัก (Key Activities)", page_break_before=False)
    add_numbered_item(doc, "1)", "พัฒนาระบบ LINE LIFF, ปรับปรุงอัลกอริทึมคิว และพัฒนาหน้าจอร้านค้า (KDS)", bold_prefix="การพัฒนาระบบ: ", space_after=1)
    add_numbered_item(doc, "2)", "ประสานงานร้านค้า ติดตั้งแท็บเล็ต อบรมการใช้งาน และดูแลความเรียบร้อยช่วงเร่งด่วน", bold_prefix="การปฏิบัติการหน้างาน: ", space_after=1)
    add_numbered_item(doc, "3)", "จัดกิจกรรมส่งเสริมการตลาดและสื่อสารประชาสัมพันธ์ในหมู่นักศึกษาและบุคลากร", bold_prefix="การตลาดและการสื่อสาร: ", space_after=1)

    add_heading_1(doc, "6.3  ทรัพยากรหลัก (Key Resources)")
    add_numbered_item(doc, "1)", "ระบบซอฟต์แวร์คลาวด์, อัลกอริทึมจัดคิว และระบบฐานข้อมูลธุรกรรมความปลอดภัยสูง", bold_prefix="เทคโนโลยี: ", space_after=1)
    add_numbered_item(doc, "2)", "แท็บเล็ตประจำร้านค้า และป้าย Standee พร้อมสติกเกอร์ QR Code ประจำโต๊ะอาหาร", bold_prefix="อุปกรณ์กายภาพ: ", space_after=1)
    add_numbered_item(doc, "3)", "ทีมงานพัฒนาซอฟต์แวร์ และบุคลากร On-site Support ให้ความช่วยเหลือผู้ใช้งาน", bold_prefix="บุคลากร: ", space_after=1)

    add_heading_1(doc, "6.4  คุณค่าที่ส่งมอบ (Value Propositions)")
    add_body_p(doc, "สำหรับนักศึกษาและบุคลากร: ส่งมอบ 'ความสะดวกรวดเร็ว ไร้การรอคอย' สามารถสั่งอาหารล่วงหน้าก่อนพักเที่ยง ชำระเงินไร้เงินสด และเดินมารับอาหารได้พอดีเวลาโดยไม่ต้องยืนรอคิว ช่วยประหยัดเวลาเฉลี่ย 20-25 นาทีต่อมื้อ", space_after=1)
    add_body_p(doc, "สำหรับผู้ประกอบการร้านอาหาร: ช่วยเพิ่มยอดขายในชั่วโมงเร่งด่วนได้มากกว่าร้อยละ 25 ลดข้อผิดพลาดของคำสั่งซื้อด้วยระบบหน้าจอ KDS และคิดค่าบริการต่ำและเป็นธรรม ไม่สร้างภาระต้นทุน", space_after=1)

    add_heading_1(doc, "6.5  ความสัมพันธ์กับลูกค้า (Customer Relationships)")
    add_numbered_item(doc, "1)", "ให้บริการสั่งอาหารและชำระเงินแบบอัตโนมัติผ่าน LINE ตลอด 24 ชั่วโมง ใช้งานง่ายและสะดวกสบาย", bold_prefix="Automated Self-Service: ", space_after=1)
    add_numbered_item(doc, "2)", "แจ้งเตือนสถานะอาหาร 3 ขั้นตอนตรงสู่แชท LINE เพื่อให้ผู้ใช้รับรู้ความคืบหน้าอย่างต่อเนื่อง", bold_prefix="Instant Notification: ", space_after=1)
    add_numbered_item(doc, "3)", "มีแอดมินให้ความช่วยเหลือและรับฟังข้อเสนอแนะเพื่อนำมาปรับปรุงระบบอย่างสม่ำเสมอ", bold_prefix="Customer Support: ", space_after=1)

    # --- Page 3 ---
    add_heading_1(doc, "6.6  ช่องทางการเข้าถึง (Channels)", page_break_before=False)
    add_numbered_item(doc, "1)", "LINE Official Account (LIFF Application) ที่เปิดใช้งานได้ทันทีโดยไม่ต้องติดตั้งแอปพลิเคชัน", bold_prefix="ช่องทางดิจิทัล: ", space_after=1)
    add_numbered_item(doc, "2)", "ป้าย Standee และสติกเกอร์ QR Code บนโต๊ะอาหารทุกโต๊ะในโรงอาหารกลาง มจพ.", bold_prefix="ช่องทางกายภาพ: ", space_after=1)
    add_numbered_item(doc, "3)", "กลุ่มเฟซบุ๊ก, เพจกิจกรรมนักศึกษา มจพ., และการบอกต่อแบบปากต่อปาก (Word of Mouth)", bold_prefix="สื่อประชาสัมพันธ์: ", space_after=1)

    add_heading_1(doc, "6.7  กลุ่มลูกค้าเป้าหมาย (Customer Segments)")
    add_numbered_item(doc, "1)", "นักศึกษา มจพ. ทุกชั้นปีที่มีข้อจำกัดด้านเวลาพักกลางวัน และชื่นชอบความสะดวกรวดเร็ว", bold_prefix="กลุ่มผู้บริโภคหลัก: ", space_after=1)
    add_numbered_item(doc, "2)", "อาจารย์และเจ้าหน้าที่สายสนับสนุนในมหาวิทยาลัยที่ต้องการบริหารเวลาอย่างมีประสิทธิภาพ", bold_prefix="กลุ่มผู้บริโภครอง: ", space_after=1)
    add_numbered_item(doc, "3)", "ร้านอาหารปรุงสดในโรงอาหารที่ต้องการขยายยอดขายและยกระดับการจัดการครัว", bold_prefix="กลุ่มผู้ประกอบการ: ", space_after=1)

    add_heading_1(doc, "6.8  โครงสร้างต้นทุน (Cost Structure)")
    add_numbered_item(doc, "1)", "ค่าบริการ Cloud Server และ Managed PostgreSQL / Redis สำหรับประมวลผลระบบ", bold_prefix="ต้นทุนระบบคลาวด์: ", space_after=1)
    add_numbered_item(doc, "2)", "ค่าบริการ LINE Messaging API สำหรับส่งข้อความ Push Notification แจ้งเตือนสถานะ", bold_prefix="ต้นทุน API: ", space_after=1)
    add_numbered_item(doc, "3)", "ค่าจัดซื้อแท็บเล็ตประจำร้านค้า และค่าจัดทำสื่อประชาสัมพันธ์ ป้าย Standee และ QR Code", bold_prefix="ต้นทุนอุปกรณ์และการตลาด: ", space_after=1)

    add_heading_1(doc, "6.9  แหล่งที่มารายได้ (Revenue Streams)")
    add_numbered_item(doc, "1)", "ค่าธรรมเนียมธุรกรรมจากร้านค้า (Micro-transaction Fee 3 - 5% ต่อยอดออเดอร์)", bold_prefix="ค่าธรรมเนียมระบบ: ", space_after=1)
    add_numbered_item(doc, "2)", "ระบบสมาชิกรายงานวิเคราะห์ยอดขายและพฤติกรรมลูกค้าสำหรับร้านค้า (199 บาท/เดือน)", bold_prefix="Merchant Analytics: ", space_after=1)
    ...
    # --- Page 2 ---
    add_heading_1(doc, "7.2  กลยุทธ์ส่วนประสมทางการตลาด 4Ps สำหรับนวัตกรรมบริการ", page_break_before=False)
    ...
    # =========================================================================
    # CHAPTER 8: TECHNOLOGY & INNOVATION STRATEGY (เป๊ะ 2 หน้าเต็ม พอดีเป๊ะ)
    # =========================================================================
    start_chapter_section(doc)
    ...
    # --- Page 2 ---
    add_heading_2(doc, "หมวดที่ 3: Experience (การยกระดับประสบการณ์ลูกค้า)", page_break_before=False)
    ...
    # --- Page 1 (Title + 9.1 Risks + Figure 9.1) ---
    ...
    add_numbered_item(doc, "1)", "ร้านค้าในโรงอาหารไม่คุ้นเคยกับการใช้งานแท็บเล็ตหรือแอปพลิเคชัน", bold_prefix="ความเสี่ยงด้านการดำเนินงาน (Operational Risk - R1): ", space_after=1)
    add_numbered_item(doc, "2)", "สัญญาณอินเทอร์เน็ตในโรงอาหารขัดข้องหรือเซิร์ฟเวอร์หยุดทำงานช่วงเร่งด่วน", bold_prefix="ความเสี่ยงด้านเทคโนโลยี (Technological Risk - R2): ", space_after=1)
    add_numbered_item(doc, "3)", "ยอดสั่งซื้อลดลงช่วงปิดภาคการศึกษาของมหาวิทยาลัย", bold_prefix="ความเสี่ยงด้านตลาดและความผันผวน (Market Risk - R3): ", space_after=1)
    add_numbered_item(doc, "4)", "การเข้ามาทำโปรโมชันของแพลตฟอร์มเดลิเวอรี่ภายนอก", bold_prefix="ความเสี่ยงด้านการแข่งขัน (Competitive Risk - R4): ", space_after=1)
    add_numbered_item(doc, "5)", "ข้อผิดพลาดในการตรวจสอบสลิปการโอนเงินหรือระบบตัดจ่าย", bold_prefix="ความเสี่ยงด้านการเงินและความปลอดภัย (Financial Risk - R5): ", space_after=1)
    add_numbered_item(doc, "6)", "การเปลี่ยนแปลงกฎระเบียบการจัดระเบียบโรงอาหารของมหาวิทยาลัย", bold_prefix="ความเสี่ยงด้านกลยุทธ์และนโยบาย (Strategic Risk - R6): ", space_after=1)
    ...
    add_figure(doc, risk_img, "9.1", "เมทริกซ์การประเมินระดับความเสี่ยง (Risk Assessment Matrix)", width_inches=3.4)

    # --- Page 2 (Table 9.1 unbroken + 9.3 BCP) ---
    ...
    risk_data = [
        ...
        ["R2", "อินเทอร์เน็ตขัดข้อง", "ปานกลาง", "สูง", "สูง (High)", "ติดตั้ง 4G/5G Router สำรอง และระบบ Offline Contingency Mode"],
        ["R3", "ยอดสั่งซื้อลดลงช่วงปิดเทอม", "สูง", "ปานกลาง", "ปานกลาง (Med)", "จัดแคมเปญช่วง Summer และลดค่าใช้จ่ายคลาวด์แบบ Pay-per-use"],
        ["R4", "การแข่งขันจากเดลิเวอรี่", "ต่ำ", "ปานกลาง", "ต่ำ (Low)", "เน้นจุดแข็งไม่มีค่า GP 35% ค่าอาหารราคาเท่าหน้าร้าน"],
        ["R5", "สลิปโอนเงินปลอม", "ปานกลาง", "สูง", "สูง (High)", "ใช้ระบบ Slip Verification API ตรวจสอบกับธนาคารอัตโนมัติ"],
        ["R6", "การปรับระเบียบโรงอาหาร", "ต่ำ", "สูง", "ปานกลาง (Med)", "ทำบันทึกข้อตกลง (MOU) ร่วมกับฝ่ายบริหารอาคาร มจพ."]
    ]
    add_styled_table(doc, "9.1", "ตารางการประเมินความเสี่ยงและมาตรการบริหารจัดการความเสี่ยง", risk_headers, risk_data, [Inches(0.6), Inches(1.8), Inches(0.6), Inches(0.7), Inches(1.0), Inches(2.0)], page_break_before=False)

    add_heading_1(doc, "9.3  แผนบริหารความต่อเนื่องทางธุรกิจ (Business Continuity Plan: BCP)")
    add_body_p(doc, "เพื่อเตรียมความพร้อมรับมือกับเหตุการณ์ไม่คาดคิด ได้กำหนดแผนการบริหารความต่อเนื่อง 4 ขั้นตอน:")
    add_numbered_item(doc, "1)", "ระบบคลาวด์มีการตั้งค่า Multi-AZ Failover หากเซิร์ฟเวอร์หลักหยุดทำงาน ระบบจะสลับไปยังเซิร์ฟเวอร์สำรองภายใน 30 วินาที", bold_prefix="กรณีเซิร์ฟเวอร์ขัดข้อง: ", space_after=1)
    add_numbered_item(doc, "2)", "แท็บเล็ตร้านค้ามีซิมการ์ด 5G สำรอง และระบบสามารถสลับเข้าสู่ 'Local Wi-Fi Mode' เพื่อออกตั๋วคิวกระดาษได้ทันที", bold_prefix="กรณีระบบอินเทอร์เน็ตล่ม: ", space_after=1)
    add_numbered_item(doc, "3)", "กรณีระบบ API ธนาคารล่าช้า ร้านค้าสามารถตรวจสอบสลิปผ่านหน้าจอแอปธนาคารโดยตรงได้ทันที", bold_prefix="กรณีระบบชำระเงินขัดข้อง: ", space_after=1)
    add_numbered_item(doc, "4)", "สำรองข้อมูลคำสั่งซื้อและบัญชีผู้ใช้งานแบบ Automated Daily Snapshot ไปยังคลาวด์ที่ปลอดภัย", bold_prefix="การสำรองและกู้คืนข้อมูล: ", space_after=1)

    # =========================================================================
    # CHAPTER 10: SUMMARY, ROADMAP & FINANCIALS (เป๊ะ 2 หน้าเต็ม พอดีเป๊ะ)
    # =========================================================================
    start_chapter_section(doc)
    add_chapter_title(doc, "10", "บทสรุป แผนการดำเนินงาน และความเป็นไปได้ทางการเงิน\n(Summary, Roadmap & Financial Feasibility)")

    # --- Page 1 (Title + 10.1 + Table 10.1 unbroken) ---
    ...
    add_styled_table(doc, "10.1", "แผนงานและเส้นทางการดำเนินโครงการ Smart Queue Food", road_headers, road_data, [Inches(1.4), Inches(2.8), Inches(2.4)])

    # --- Page 2 (10.3 Financials + 10.4 CSF + 10.5 Future) ---
    add_heading_1(doc, "10.3  การวิเคราะห์จุดคุ้มทุนและความเป็นไปได้ทางการเงิน", page_break_before=False)
    add_numbered_item(doc, "1)", "ค่าอาหารเฉลี่ย 50 บาทต่อออเดอร์ คิดค่าธรรมเนียมระบบ 4% (2.00 บาทต่อออเดอร์) ในระยะนำร่อง 15 ร้านค้า มียอดสั่งซื้อเฉลี่ย 1,000 ออเดอร์ต่อวัน รายได้ค่าธรรมเนียมประมาณ 52,000 บาทต่อเดือน รวมค่าสมาชิก Analytics (15 ร้าน x 199 บาท = 2,985 บาท) และค่าโฆษณา 5,000 บาท รวมรายได้เฉลี่ยเดือนละประมาณ 60,000 บาท", bold_prefix="ประมาณการรายได้: ", space_after=1)
    add_numbered_item(doc, "2)", "ค่าบริการคลาวด์ 3,000 บาทต่อเดือน, ค่า LINE API 2,000 บาทต่อเดือน, ค่าบำรุงรักษาและการตลาด 10,000 บาทต่อเดือน รวมต้นทุนคงที่เดือนละ 15,000 บาท กำไรสุทธิจากการดำเนินงานประมาณ 45,000 บาทต่อเดือน", bold_prefix="ต้นทุนการดำเนินงาน: ", space_after=1)
    add_numbered_item(doc, "3)", "เงินลงทุนเริ่มต้นพัฒนาระบบ จัดหาแท็บเล็ต 15 เครื่อง และสื่อการตลาด รวมทั้งสิ้นประมาณ 120,000 บาท ด้วยกำไรจากการดำเนินงานเดือนละ 45,000 บาท โครงการจะสามารถคืนทุน (Payback Period) ได้ภายในระยะเวลาประมาณ 7 เดือนหลังเปิดให้บริการเต็มรูปแบบ", bold_prefix="การวิเคราะห์จุดคุ้มทุน (Break-Even): ", space_after=1)
    ...
    add_numbered_item(doc, "3)", "การสนับสนุนเชิงนโยบายจากฝ่ายบริหารอาคารสถานที่และมหาวิทยาลัย", space_after=1)
    add_numbered_item(doc, "4)", "การรักษามาตรฐานการบริการที่สะดวกรวดเร็วจนผู้ใช้งานเกิดความภักดีและใช้งานเป็นประจำทุกวัน", space_after=1)
    ...
    add_figure(doc, orig_poster, "ก.1", "ภาพถ่ายโปสเตอร์ Business Model Canvas ต้นฉบับโครงงาน Smart Queue Food", width_inches=3.8)
